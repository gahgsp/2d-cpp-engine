...
KeyboardComponent::KeyboardComponent(std::string upKey, std::string rightKey, std::string downKey, std::string leftKey,
                                     std::string shootKey) {
...
void KeyboardComponent::Update(float deltaTime) {
